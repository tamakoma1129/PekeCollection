...
<template>
    <div class="w-[80vw] h-[90vh] bottom-[5vh] rounded-xl fixed -translate-x-1/2 flex flex-col justify-between py-40" :style="`background: ${subColor}`">
        <img v-if="mediaStore.raw_image_path"
