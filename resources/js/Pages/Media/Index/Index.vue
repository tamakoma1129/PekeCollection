...
Echo.private("login").listen("MediaProcessedEvent", (event) => {
...
<template>
    ...
    <div class="bg-white rounded-xl py-8 mb-16">
        <div class="flex justify-between items-center pt-8 px-16">
            ...
            <div class="mb-4 flex">
                <button
                    class="border-y border-y-sumi-400 border-l border-l-sumi-400 rounded-l-lg p-4 w-64 flex justify-center hover:bg-sumi-300"
                ...
                <button
                    class="border-y border-y-sumi-400 border-r border-r-sumi-400 rounded-r-lg p-4 w-64 flex justify-center hover:bg-sumi-300"
    ...
    <ul
        class="flex divide-y divide-sumi-400 p-16 bg-white rounded-xl"
