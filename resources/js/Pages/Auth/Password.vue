...
<template>
    ...
    <div class="bg-white rounded-xl mb-16">
        <h2
            class="text-xl font-semibold leading-tight text-gray-800 p-16"
        >
            パスワードの設定
        </h2>
    </div>
    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl space-y-24 sm:px-24 lg:px-40">
            <div
                class="bg-white p-16 shadow sm:rounded-lg sm:p-40"
            >
                <section>
                    <header>
                    ...
                    <form @submit.prevent="updatePassword" class="mt-24 space-y-24">
                        <div>
                        ...
                        <div>
                            ...
                            <InputError :message="form.errors.password" class="mt-8" />
                        </div>
